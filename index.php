...
_Hasync.push(['Histats.start', '1,5021046,4,0,0,0,00010000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?5021046&101" alt="frontpage hit counter" border="0"></a></noscript>
<!-- Histats.com  END  -->
    <meta charset="utf-8" />
    ...
    <meta
      name="description"
      content="Freebie 64 - Portfolio (Tailwind CSS). Check out more."
    />
      ...
      >
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-12">
          ...
          >
            <div
              aria-hidden="true"
              class="absolute -top-20 -left-20 size-48 rounded-full bg-yellow-500 blur-2xl"
            ></div>
            <div
              aria-hidden="true"
              class="absolute -top-10 -right-10 size-64 rounded-full bg-orange-300 blur-3xl"
            ></div>
            <div
              aria-hidden="true"
            ...
            <div class="relative mt-auto">
              ...
              <h2 class="mt-3 leading-relaxed text-zinc-900 dark:text-zinc-200">
                I'm a passionate graphic designer with 5+ years of experience
                creating beautiful and functional designs. I specialize in
                branding, web design, and print media that tells your story and
          ...
          >
            ...
            >
              <img
                ...
                alt="Project 1"
                class="rounded-xl object-contain w-full aspect-square"
              />
            </div>
          </a>
          <a
          ...
          >
            <div
              aria-hidden="true"
              class="absolute -top-20 -left-20 size-48 rounded-full bg-pink-300 blur-2xl"
            ></div>
            <div
              aria-hidden="true"
            ...
            <div class="relative mx-auto mt-auto max-w-md">
              ...
              <form onsubmit="return false;" class="mt-10 w-full space-y-6">
                ...
                <div class="space-y-2">
                  <label for="message" class="inline-block text-sm font-medium"
                    >Message</label
                  >
                  <textarea
                    id="message"
          ...
          >
            <nav class="flex items-center justify-center gap-4">
              ...
              <a
                href="https://github.com/themewagon/olivia"
            ...
            <div class="text-zinc-500 dark:text-zinc-400/80">
              ...
              <p>All right reserved by <a href="https://pixelcave.com/" target="_blank" class="font-bold">Pixelcave</a> • Distributed by <a href="https://themewagon.com" target="_blank" class="font-bold">ThemeWagon</a></p>
            </div>
          </footer>
          <!-- END Footer -->
        </div>
